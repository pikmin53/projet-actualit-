...
export default function HomePage() {
  ...
  return (
    <div className="grid h-[calc(100vh-65px)] grid-cols-1 lg:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)]">
      <div className="relative min-w-0">
        <NewsGlobe points={globePoints} selectedId={selectedId} onSelectPoint={handleSelect} />
      </div>
      <div className="flex min-h-0 min-w-0 flex-col overflow-hidden border-l border-white/10">
