...
| 3 | Social : Reddit en polling, puis Bluesky ; logique "évènement candidat → confirmation" | 0 € | Table/état pour les candidats non confirmés |
| 4 | Science : arXiv + Crossref + EurekAlert ; catégorie `science` | 0 € | Ajouter `science` au type `Category` + à la catégorisation |
